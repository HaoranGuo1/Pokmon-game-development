[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/Ecg3OlGz)
# Assignment 3
...
5. Execute `ls`. There will now be a new directory called `assignment-3-pokemon-battle-XXX`, where `XXX` is your GitHub username. Enter that directory via `cd`.
...
The starter code does not contain all of the files that you'll need to submit. You'll need to create some new .hpp and .cpp files. See the implementation requirements in the assignment document.
